...
Module Module1
    ...
    Private Sub OnCaptured(ByVal captureResult As CaptureResult)
        ...
        For Each fp_a As String In sarray
            compareResult = Comparison.Compare(resultConversion.Data, 0, Fmd.DeserializeXml(fp_a), 0)
            If compareResult.Score < (&H7FFFFFFF / 100000) Then
                Console.WriteLine("Usuario Validado")
                Exit For
                'File.WriteAllText("c:\temp\result.txt", "1")
            End If
        Next
